...
Version  : 1.8.2.2
Release  : 37
URL      : https://cran.r-project.org/src/contrib/rootSolve_1.8.2.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rootSolve_1.8.2.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625589869
