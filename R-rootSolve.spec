...
Version  : 1.8.1
Release  : 24
URL      : https://cran.r-project.org/src/contrib/rootSolve_1.8.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rootSolve_1.8.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573672847
